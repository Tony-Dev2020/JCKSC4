...
public partial class select_remaindepot_list : System.Web.UI.Page
{
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("remaindepot_list.aspx", "product_category_id={0}&note_no={1}&company={2}&page={3}", this.product_category_id.ToString(), this.note_no, this.company, "__id__");
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(Utils.CombUrlTxt("remaindepot_list.aspx", "product_category_id={0}&note_no={1}&company={2}", this.product_category_id.ToString(), txtNote_no.Text, this.ddldepot_category_id.SelectedValue));
    }

    //筛选商品类别
    protected void ddlproduct_category_id_SelectedIndexChanged(object sender, EventArgs e)
    {
        Response.Redirect(Utils.CombUrlTxt("remaindepot_list.aspx", "product_category_id={0}&note_no={1}&company={2}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.ddldepot_category_id.SelectedValue));
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("remaindepot_rep.aspx", "product_category_id={0}&note_no={1}&company={2}", this.product_category_id.ToString(), txtNote_no.Text, this.ddldepot_category_id.SelectedValue));
    }
