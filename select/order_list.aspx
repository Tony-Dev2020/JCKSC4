<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_list.aspx.cs" Inherits="select_order_list" %>
...
<body>
    ...
    <span class="rule-single-select">
        <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" onselectedindexchanged="ddlStatus_SelectedIndexChanged">
            ...
            <asp:ListItem Value="3">已设计</asp:ListItem>
            <asp:ListItem Value="4">已确认设计</asp:ListItem>
            <asp:ListItem Value="5">已报价</asp:ListItem>
            <asp:ListItem Value="6">已确认报价</asp:ListItem>
            <asp:ListItem Value="7">已汇款</asp:ListItem>
            <asp:ListItem Value="8">已确认收款</asp:ListItem>
            <asp:ListItem Value="9">已排产</asp:ListItem>
            <asp:ListItem Value="10">已取消</asp:ListItem>
          </asp:DropDownList>
    </span>
    </dd>
    ...
    <ItemTemplate>
        <tr>
            ...
            <td><a href="order_edit.aspx?action=Edit&id=<%#Eval("id")%>&IsSearch=1" class="tablelink"> 查看详情</a> </td>
        </tr> 		
 	   </ItemTemplate>
    <FooterTemplate>
