...
public partial class select_part_select : System.Web.UI.Page
{
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("part_select.aspx", "product_category_id={0}&note_no={1}&company={2}&page={3}", this.product_category_id.ToString(), this.note_no, this.company, "__id__");
    ...
    {
        //Response.Redirect(Utils.CombUrlTxt("part_select.aspx", "product_category_id={0}&note_no={1}", this.product_category_id.ToString(), txtNote_no.Text));
        Response.Redirect(Utils.CombUrlTxt("part_select.aspx", "product_category_id={0}&note_no={1}&Company={2}&product_series_id={3}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.ddldepot_category_id.SelectedValue, this.ddlproduct_series_id.SelectedValue));
    }
    ...
    {
        //Response.Redirect(Utils.CombUrlTxt("part_select.aspx", "product_category_id={0}&note_no={1}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text));
        Response.Redirect(Utils.CombUrlTxt("part_select.aspx", "product_category_id={0}&note_no={1}&Company={2}&product_series_id={3}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.ddldepot_category_id.SelectedValue, this.ddlproduct_series_id.SelectedValue));
    }
    ...
    protected void lbtnAcceptCa_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 设置成功！", Utils.CombUrlTxt("part_select.aspx", "product_category_id={0}&note_no={1}", this.product_category_id.ToString(), txtNote_no.Text), "Success");
    }
