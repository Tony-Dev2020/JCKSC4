...
public partial class depotmanager_kit_list : System.Web.UI.Page
{
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        this.rptList.DataSource = bll.GetKitList(this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
        this.rptList.DataBind();

        //绑定页码
        txtPageNum.Text = this.pageSize.ToString();
        string pageUrl = Utils.CombUrlTxt("kit_list.aspx", "product_category_id={0}&note_no={1}&company={2}&page={3}", this.product_category_id.ToString(), this.note_no, this.company, "__id__");
    ...
    protected string CombSqlTxt(int _product_category_id, string _note_no, string _company, int _product_series_id)
    {
        ...
        //strTemp.Append(" and categorycode like '%套件%' ");
        strTemp.Append(" and is_kit=1 ");
    ...
    {
        //Response.Redirect(Utils.CombUrlTxt("kit_list.aspx", "product_category_id={0}&note_no={1}", this.product_category_id.ToString(), txtNote_no.Text));
        Response.Redirect(Utils.CombUrlTxt("kit_list.aspx", "product_category_id={0}&note_no={1}&Company={2}&product_series_id={3}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.ddldepot_category_id.SelectedValue, this.ddlproduct_series_id.SelectedValue));
    }
    ...
    {
        //Response.Redirect(Utils.CombUrlTxt("kit_list.aspx", "product_category_id={0}&note_no={1}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text));
        Response.Redirect(Utils.CombUrlTxt("kit_list.aspx", "product_category_id={0}&note_no={1}&Company={2}&product_series_id={3}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.ddldepot_category_id.SelectedValue, this.ddlproduct_series_id.SelectedValue));
    }
    ...
    protected void lbtnAcceptCa_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 设置成功！", Utils.CombUrlTxt("kit_list.aspx", "product_category_id={0}&note_no={1}", this.product_category_id.ToString(), txtNote_no.Text), "Success");
    }
