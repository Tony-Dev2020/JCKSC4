...
<asp:DropDownList ID="ddldepot_id"  runat="server" AutoPostBack="True" onselectedindexchanged="ddldepot_id_SelectedIndexChanged">
	  ...
	  <table class="tablelistl">
		...
		<th width="100px;">折扣金额<br /><font color="red">(<asp:Literal ID="Literal_ra" runat="server"></asp:Literal>)</font></th>
    ...
    <ItemTemplate>
        <tr>
            ...
            <td><a href="../select/order_edit.aspx?action=Edit&id=<%#Eval("id")%>&status=8" class="tablelink"> 处理订单</a> </td>
        </tr> 		
 	   </ItemTemplate>
    <FooterTemplate>
