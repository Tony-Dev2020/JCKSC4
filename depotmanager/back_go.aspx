<%@ Page Language="C#" AutoEventWireup="true" CodeFile="back_go.aspx.cs" Inherits="depotmanager_back_go" %>
      ...
      <asp:DropDownList ID="ddlproduct_category_id"  runat="server" AutoPostBack="True" onselectedindexchanged="ddlproduct_category_id_SelectedIndexChanged">
       ...
       <dd class="cx"><asp:Button ID="lbtnSearch" runat="server" CssClass="scbtn" onclick="btnSearch_Click" Text="查询"></asp:Button>   
        ...
        <tr>
            ...
            <td><%--<a href="javascript:opdg('info','product_info.aspx?id=<%#Eval("id")%>');" class="tablelink"> 查看</a>--%>  &nbsp;&nbsp;<a href="back_go_add.aspx?action=Edit&id=<%#Eval("id")%>&page=<%=page%>" class="tablelink"><font color =green>[出库]</font></a></td>
        </tr>      
	   </ItemTemplate>
<FooterTemplate>
