     ...
     <dd class="toolbar1">
	  ...
	  <table class="tablelistl">
    	...
    	<tr>
            ...
            <th width="8%">订单状态</th>
	        <th width="100px;">折扣前总金额<br /><font color="red">(<asp:Literal ID="Literal_pa" runat="server"></asp:Literal>)</font></th>
		    <th width="100px;">折扣总金额<br /><font color="red">(<asp:Literal ID="Literal_ra" runat="server"></asp:Literal>)</font></th>
            <th width="100px;">实付总金额<br /><font color="red">(<asp:Literal ID="Literal_oa" runat="server"></asp:Literal>)</font></th>
            ...
            <ItemTemplate>
                    <tr>
                        ...
                        <% if (Session["IsDisplayPrice"]==null || Session["IsDisplayPrice"].ToString() == "1") {%>
                         ...
                         <td><%# MyConvert(Eval("discount_amount"))%></td>	
                       ...
                       &nbsp;&nbsp;<asp:LinkButton ID="lbtnDelCa" runat="server" CommandArgument='<%# Eval("id")%>' OnClientClick="return confirm('是否真的要取消该订单吗？')" onclick="lbtnDelCa_Click"><%# (Convert.ToInt32(Eval("status")) < 2 ||  Convert.ToInt32(Eval("status")) ==3) ? "<font color =red>[取消订单]</font>" : ""%></asp:LinkButton>
                        &nbsp;&nbsp;<asp:LinkButton ID="lbtnCart" runat="server" CommandArgument='<%# Eval("id")%>' OnClientClick="return confirm('是否真的要重新加入购购物？')" onclick="lbtnCart_Click"><font color="green">[重新加入购物车]</font></asp:LinkButton>
