...
public partial class purchase_purchase_undelivery_list : System.Web.UI.Page
{
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        string pageUrl = Utils.CombUrlTxt("purchase_undelivery_list.aspx", "product_category_id={0}&note_no={1}&product_series_id={2}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.ddlproduct_series_id.SelectedValue, "__id__");
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("purchase_undelivery_list.aspx", "product_category_id={0}&note_no={1}&product_series_id={2}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.ddlproduct_series_id.SelectedValue));
    }
    ...
    protected void lbtnDelCa_Click(object sender, EventArgs e)
    {
        ...
        mym.JscriptMsg(this.Page, " 取消订单成功！", Utils.CombUrlTxt("purchase_undelivery_list.aspx", "product_category_id={0}&note_no={1}&product_series_id={2}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text, this.ddlproduct_series_id.SelectedValue), "Success");
    }
    //小数位是0的不显示
