<%@ Page Language="C#" AutoEventWireup="true" CodeFile="purchase_undelivery_list.aspx.cs" Inherits="purchase_purchase_undelivery_list" %>
...
<body>
    ...
    <span class="rule-single-select">
     ...
     <dd class="toolbar1">
     <li><span><img src="../images/t04.png" /></span><a href="purchase_undelivery_edit.aspx">建立送货单&nbsp;<%--<font color=red><script type="text/javascript" src="../tools/submit_ajax.ashx?action=view_cart_count"></script></font>&nbsp;种--%></a></li>
        </dd>
        </dl>
            <!--列表-->
        ...
        <asp:Repeater ID="rptList" runat="server">
            <ItemTemplate>
                    <tr>
                        ...
                        <td><a href="javascript:void(0);"  class=addpo onclick="CartAdd(this, '/', 0, 'shopping.aspx?action=cart','"+ Eval("id")+"','1');" ></a>      
                        </td>
                    </tr> 		
 	               </ItemTemplate>
            <FooterTemplate>
