...
<body>
    ...
    <div class="rightinfo">    
    <div class="tools">  
    	<ul class="toolbar" style="visibility:hidden">
        <a href="vendor_edit.aspx?action=Add"><li><span><img src="../images/t01.png" /></span>添加</li></a>
...
<asp:Repeater ID="rptList" runat="server">
    ...
    <ItemTemplate> 
        ...
        <td><%# Eval("PhoneNum")%></td>
        <td><%# Eval("Address1")%></td>
        <td><%# Convert.ToInt32(Eval("Inactive")) == 1 ? "<font color=red>已注销</font>" : "在用"%></td>
