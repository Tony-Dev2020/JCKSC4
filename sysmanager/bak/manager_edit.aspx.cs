...
public partial class sysmanager_manager_edit : System.Web.UI.Page
{
    ...
    private void VendorBind(int _category_id)
    {
        ...
        _category_id = ddlCategoryId.SelectedValue == "" ? -1 : Convert.ToInt32(ddlCategoryId.SelectedValue);
        DataTable dt = bll.GetListByCatID(_category_id," (name like '%"+ this.txtVendorKeyWord.Text.Trim() + "%' or vendorid like '%" + this.txtVendorKeyWord.Text.Trim() + "%')");
    ...
    private bool DoAdd()
    {
        ...
        //{
        //    model.vendor_id = int.Parse(txtVendorID.Text.Trim());
        //}
        //else
        //{
        //    model.vendor_id = 0;
